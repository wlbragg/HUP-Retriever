...
setlistener("/sim/signals/fdm-initialized", func (n) {
  ...
  var model_path = "Aircraft/HUP-Retriever/Models/Cargo-Hauling/";
...
var cargo_init = func () {
  ...
  foreach(var cargoN; props.globals.getNode("/models/cargo", 1).getChildren("cargo")){
      ...
      if (getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/saved") == 1) {
        cargoN.getNode("latitude-deg").setDoubleValue(getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/latitude-deg"));
        cargoN.getNode("longitude-deg").setDoubleValue(getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/longitude-deg"));	
        cargoN.getNode("elevation-ft").setDoubleValue(getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/altitude-ft"));
        cargoN.getNode("heading-deg").setDoubleValue(getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/orientation/true-heading-deg"));
        aircraft.data.add("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/latitude-deg",
          "/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/longitude-deg",
          "/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/position/altitude-ft",
          "/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/orientation/true-heading-deg",
          "/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/saved");
        aircraft.data.save();
      } else
        if (getprop("/sim/model/HUP-Retriever/"~cargoN.getNode("callsign").getValue()~"/random") == 1) {
...
var cargo_tow = func () {
  ...
  var aircraft_alt_ft = getprop("/position/altitude-ft") - 5.92;
  ...
  if (hooked == 1) {
    ...
    if (!longline) {
      ...
      if (longline and !cargoOnGround) {
        ...
        if (cargo_dist > (ropeLength + 3)) {
          ...
          #x and y transformation to move cargo (incrementally) towards HUP-Retriever as rope is taut and pulling cargo
	...
	if (cargoReleased == 1) {
      ...
      if (getprop("/sim/model/HUP-Retriever/"~cargoName~"/saved")) {
        #gui.popupTip(cargoName~" position saved", 1);
        setprop("/sim/model/HUP-Retriever/"~cargoName~"/position/latitude-deg", getprop("/models/cargo/" ~ cargoParent ~ "/latitude-deg"));
        setprop("/sim/model/HUP-Retriever/"~cargoName~"/position/longitude-deg", getprop("/models/cargo/" ~ cargoParent ~ "/longitude-deg"));
        setprop("/sim/model/HUP-Retriever/"~cargoName~"/position/altitude-ft", getprop("/models/cargo/" ~ cargoParent ~ "/elevation-ft"));
        setprop("/sim/model/HUP-Retriever/"~cargoName~"/orientation/true-heading-deg", getprop("/models/cargo/" ~ cargoParent ~ "/heading-deg"));
        aircraft.data.add("/sim/model/HUP-Retriever/"~cargoName~"/position/latitude-deg",
                          "/sim/model/HUP-Retriever/"~cargoName~"/position/longitude-deg",
                          "/sim/model/HUP-Retriever/"~cargoName~"/position/altitude-ft",
                          "/sim/model/HUP-Retriever/"~cargoName~"/orientation/true-heading-deg");
        aircraft.data.save();
      }
      cargoName="";
      cargoReleased=0;
...
setlistener("/sim/signals/click", func {
  if (__kbd.shift.getBoolValue()) {
      ...
      if (aic != nil) {
        ...
        gui.popupTip("No Cargo Selected, first select cargo to move in the HUP-Retriever's Cargo Menu", 3);
      }
	  }
  }
});
