  ...
  if (overland)
    {
      ...
      if ((alt_agl + 1.95) - ((n_segments - n_segments_reeled) * segment_length) < 0.0)
			  onground_flag = 1;
		  else
			  onground_flag = 0;

setprop("Aa-cargo-onground-num", (((alt_agl+1.6) - ((n_segments - n_segments_reeled) * segment_length)) + cargo_harness + cargo_height));
setprop("Ab-cargo-onground", cargoOnGround_flag);
setprop("Ac-onground-num", (alt_agl+1.95) - ((n_segments - n_segments_reeled) * segment_length));
setprop("Ad-onground", onground_flag);
